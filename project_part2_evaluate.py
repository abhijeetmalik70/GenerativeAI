...
if __name__ == "__main__":        
    model_selected = "<<PATH_TO_THE_MODEL>>" # Change this to point to the path of the model you want to evaluate
    
    compiler = utils.Compiler()
    distance = utils.Distance()
        
    repair_agent = repair.Repair(model_name=model_selected, is_huggingface=True)
    hint_agent = hint.Hint(model_name=model_selected, is_huggingface=True)
    ...
    datasetEvaluator.evaluate_dataset(save_path="./project_part2_evaluation_results/")